            ...
            <form action="" method="post">
                ...
                if (isset($_POST['email'])) {
                    ...
                    if ($contador > 0) {
                        ...
                        $email_conteudo .= "<a href='https://mestresderuneterra.com.br/reset_pwd.php?e=" . $email_remetente . "&t=" . $chave . "'>https://mestresderuneterra.com.br/reset_pwd.php?e=" . $email_remetente . "&t=" . $chave . "</a> \n";
